...
from detection_yolo3.yolo3.model import preprocess_true_boxes, yolo_body, tiny_yolo_body, yolo_loss
from detection_yolo3.yolo3.utils import get_random_data
...
def _main():
    ...
    annotation_path = YOLO3_BOOK_PAGE_TAGS_FILE  # 数据
    classes_path = 'D:/my_thesis/Chinese-ancient-book-recognition-HSK/detection_yolo3/configs/text_classes.txt'  # 类别

    log_dir = r'D:\my_thesis\Chinese-ancient-book-recognition-HSK\detection_yolo3\logs\004'  # 日志文件夹
    
    # pretrained_path = 'model_data/yolo_weights.h5'  # 预训练模型
    pretrained_path = 'logs/003/ep074-loss26.535-val_loss27.370.h5'  # 预训练模型
    anchors_path = 'D:/my_thesis/Chinese-ancient-book-recognition-HSK/detection_yolo3/configs/yolo_anchors.txt'  # anchors
...
def create_model(input_shape, anchors, num_classes, load_pretrained=True, freeze_body=2,
    ...
    plot_model(model, to_file=os.path.join('D:/my_thesis/Chinese-ancient-book-recognition-HSK/detection_yolo3/model_data',
